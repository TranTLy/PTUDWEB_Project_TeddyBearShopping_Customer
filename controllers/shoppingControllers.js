	...
	const productDb = [
		{
			...
			decription: 'Được làm từ chất liệu cao cấp, an toàn cho sức khỏe của trẻ nhỏ'
		},
		{
			id: 4,
			type: 2,
	...
	const productCar = [
		{
			...
			decription: 'Xe được làm bằng nhựa cao cấp, tốt cho trẻ nhỏ. Mẫu mã đa dạng, mới, đẹp.'
		},
		{
			id: 1,
			type: 3,
